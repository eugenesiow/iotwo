...
//      prepared.buckets[index] += parseInt(count);
      if (typeof prepared.buckets[value] === "undefined") {
    	  prepared.buckets[value] = parseInt(count);
      }
      else {
    	  prepared.buckets[value] += parseInt(count);
      }
...
//      }
    ...
    for (k = 0, len = ref1.length; k < len; k++) {
      ...
      for (bucket in ref2) {
        ...
        count = ref2[bucket];
        if (typeof bucketTotals[bucket] === "undefined") {
        	bucketTotals[bucket] = parseInt(count);
        }
        else {
        	bucketTotals[bucket] += parseInt(count);
        }
